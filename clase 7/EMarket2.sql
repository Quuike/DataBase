...
SELECT  ProductoNombre, NivelReorden, UnidadesStock
FROM productos
...
SELECT  ProductoNombre
FROM productos
WHERE ProductoNombre > UnidadesStock AND NivelReorden;

#Clientes
#Obtener un listado de todos los clientes con . Ordenar el listado por País.
SELECT    tacto, Compania, Título, País ,ClienteID
FROM clientes
ORDER BY País;
...
#Productos
#Obtener el listado de todos los productos ordenados descendentemente por .
